      ...
      <Container maxWidth="xl">
        <Grid container direction="column" className="pt-16 pb-60">
          ...
          <Grid item className="flex flex-wrap justify-center w-full gap-16 mt-8">
            ...
            <div aria-hidden onClick={() => history.push('/generalFaq')}><FaqCard image={conversations} title="General" /></div>
            <div aria-hidden onClick={() => history.push('/legalFaq')}><FaqCard image={legals} title="Legals" /></div>
          </Grid>
        </Grid>
      </Container>
    </Grid>
